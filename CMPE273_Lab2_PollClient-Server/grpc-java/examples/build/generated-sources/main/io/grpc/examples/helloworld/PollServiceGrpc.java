...
public class PollServiceGrpc {
  ...
  private static final io.grpc.stub.Method<io.grpc.examples.helloworld.PollRequest,
      io.grpc.examples.helloworld.PollResponse> METHOD_CREATE_POLL =
      io.grpc.stub.Method.create(
          io.grpc.MethodType.UNARY, "CreatePoll",
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.helloworld.PollRequest.PARSER),
          io.grpc.proto.ProtoUtils.marshaller(io.grpc.examples.helloworld.PollResponse.PARSER));
  ...
  public static class PollServiceServiceDescriptor extends
    ...
    public final io.grpc.MethodDescriptor<io.grpc.examples.helloworld.PollRequest,
        io.grpc.examples.helloworld.PollResponse> createPoll;
    ...
    private PollServiceServiceDescriptor(
      ...
      createPoll = (io.grpc.MethodDescriptor<io.grpc.examples.helloworld.PollRequest,
          io.grpc.examples.helloworld.PollResponse>) methodMap.get(
  ...
  public static interface PollService {
    ...
    public void createPoll(io.grpc.examples.helloworld.PollRequest request,
        io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.PollResponse> responseObserver);
  }

  public static interface PollServiceBlockingClient {

    public io.grpc.examples.helloworld.PollResponse createPoll(io.grpc.examples.helloworld.PollRequest request);
  }

  public static interface PollServiceFutureClient {

    public com.google.common.util.concurrent.ListenableFuture<io.grpc.examples.helloworld.PollResponse> createPoll(
        io.grpc.examples.helloworld.PollRequest request);
  }
      ...
      .addMethod(createMethodDefinition(
          ...
          asyncUnaryRequestCall(
            new io.grpc.stub.ServerCalls.UnaryRequestMethod<
                io.grpc.examples.helloworld.PollRequest,
                io.grpc.examples.helloworld.PollResponse>() {
              @java.lang.Override
              public void invoke(
                  io.grpc.examples.helloworld.PollRequest request,
                  io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.PollResponse> responseObserver) {
